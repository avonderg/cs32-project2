...
//
//    Select dbSelector = new Select(driver.findElement(By.className("selectDB")));
//    List<WebElement> dbList = dbSelector.getOptions();
//    assertEquals(3, dbList.size());
//
//    dbSelector.selectByVisibleText("movies");
//    WebElement loadDbButton = driver.findElement(By.className("dbLoadButton"));
//    loadDbButton.click();
//
...
//    WebElement loadButton = driver.findElement(By.className("tableLoadButton"));
//    loadButton.click();
//    driver.manage().timeouts().implicitlyWait(Duration.ofMillis(500));
