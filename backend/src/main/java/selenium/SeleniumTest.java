...
public class SeleniumTest {
  ...
  /**
   * Tests that the load data button can be pressed, and data is loaded onto appropriate tables
   * correctly.
   *
   * @param driver - SafariDriver
   */
  ...
  /**
   * Tests that the tables generated by the different datasets have the correct number of rows and
   * columns,
  ...
  public static void testTable(SafariDriver driver) {
    ...
    for (int row = 0; row < totalRowcount; row++) {
      ...
      for (int col = 0; col < colCount; col++) {
        ...
        System.out.println(
            "Cell value of row number " + row + " and column number " + col + " is: " + cellText);
      }
    }
  }
